...
# 读取数据
data = pd.read_csv('./data/2012-2013-data-with-predictions-4-final.csv',
                   usecols=['start_time', 'user_id', 'problem_id', 'skill_id', 'correct'],
...
# 保存结果到文件
with open('./data/log_data_2012_order.json', 'w') as file:
